    ...
    <div class="container-fluid">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
                <h1 class="h2">ALIMENTO <svg class="bi bi-egg-fried" width="1em" height="1em" viewBox="0 0 16 16"
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="cadastro-alimento.jsp" role="tab"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control" name="infos-nutricionais" id="infos-nutricionais"
                                maxlength="45"
                                placeholder="Digite aqui as informações nutricionais de maneira simplificada"></textarea>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="descricao">Descrição</label>
                            <textarea class="form-control" name="descricao" id="descricao" maxlength="20"
                                placeholder="Informe alguma descrição sobre o alimento"></textarea>
                        </div>
                    </div>
