        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="treino?acao=abrir-form-cadastro"
                        role="tab" aria-controls="home">Adicionar</a>
                </li>
            </ul>

            <h2>Inclusão de Treino</h2>
            ...
            <form method="POST" action="treino">
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" name="data-treino" id="data-treino">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="descricacao">Descrição do treino</label>
                        <textarea class="form-control" name="descricacao" id="descricacao" maxlength="25"
                            placeholder="Informe uma breve descrição sobre o treino realizado"></textarea>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="obs-treino">Observações</label>
                        <textarea class="form-control" name="observacao" id="observacao" maxlength="100"
                            placeholder="Informe algumas observações sobre o treino"></textarea>
                    </div>
                </div>
